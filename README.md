...
Senior Frontend Developer based in Israel. 12+ years building for the web. I create open-source tools and data pipelines that run themselves.

**Stack:** TypeScript · Node.js · Angular · Astro · Web Components · GitHub Actions

**Philosophy:** SOLID over clever. Ship over discuss. Data over opinions. `npm` over everything else.
...
I build tools on public government data that anyone can use for free. No VC funding, no corporate backing — just one developer, a server, and a lot of coffee.

Your sponsorship goes directly to:
- 🖥️ Server costs (self-hosted, no cloud markup)
- 🤖 AI API tokens for automated content pipelines
- ☕ More open-source experiments

Every project I build ships free and stays free.

<a href="https://github.com/sponsors/bullwinkle">
  <img src="https://img.shields.io/badge/Sponsor-❤️-ea4aaa?style=for-the-badge&logo=github-sponsors" alt="Sponsor me" />
</a>
...
<!-- sponsors -->
Be the first 🐿️ → [github.com/sponsors/bullwinkle](https://github.com/sponsors/bullwinkle)
<!-- sponsors -->
